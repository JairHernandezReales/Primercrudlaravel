...
Route::get('/', [ControladorController::class, 'index'])->name('public.inicio');
Route::get('/nuestrosProductos', [ControladorController::class, 'productos'])->name('public.productos');
Route::get('/quienesSomos', [ControladorController::class, 'quienessomos'])->name('public.quienessomos');
Route::get('/contactanos', [ControladorController::class, 'contactanos'])->name('public.contactanos');
Route::post('/cart/add', [ControladorController::class, 'addToCart'])->name('cart.add');
Route::get('/cart', [ControladorController::class, 'viewCart'])->name('cart.view');
Route::put('/cart/update/{id}', [ControladorController::class, 'update'])->name('cart.update');
Route::delete('/cart/remove/{id}', [ControladorController::class, 'remove'])->name('cart.remove');
